...
tmux send-keys -t my_session:0 "cd /home/liuqiao/project/catkin_ws/src/EPSILON/core/phy_simulator/rviz/" C-m
tmux send-keys -t my_session:0 "rviz -d phy_simulator_planning.rviz" C-m

# 在第三个窗格中启动test_ssc_with_eudm_ros.launch
tmux split-window -h -t my_session:0
tmux send-keys -t my_session:0 "roslaunch planning_integrated test_ssc_with_mpdm_ros.launch" C-m
